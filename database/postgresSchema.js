...
ALTER TABLE drivers ADD COLUMN IF NOT EXISTS is_archived INTEGER NOT NULL DEFAULT 0;
ALTER TABLE drivers ADD COLUMN IF NOT EXISTS salary_opening_accrued REAL NOT NULL DEFAULT 0;
ALTER TABLE drivers ADD COLUMN IF NOT EXISTS archived_at TEXT;
